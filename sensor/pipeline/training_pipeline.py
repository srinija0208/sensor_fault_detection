...
from sensor.entity.artifacts_entity import ModelTrainerArtifact, ModelEvaluationArtifact
...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact = data_ingestion.initiate_data_ingestion()   ## ingetsion artifact
    ...
    def start_data_validaton(self,data_ingestion_artifact:DataIngestionArtifact)->DataValidationArtifact:
        ...
        try:
            ...
            data_validation_artifact = data_validation.initiate_data_validation()  ## validation artifact
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation_artifact =  data_transformation.initiate_data_transformation()  ## creating transformation artifact
    ...
    ## sending artifact directory to s3
    ...
    def run_pipeline(self):
        try:
            ...
            TrainPipeline.is_pipeline_running = False  ## pause
