...
class TrainingPipelineConfig:
    ...
    def __init__(self,timestamp=datetime.now()):
        ...
        # self.artifact_dir: str = os.path.join(os.getcwd(),"artifact", timestamp)
...
class DataIngestionConfig:
        ...
        def __init__(self,training_pipeline_config:TrainingPipelineConfig): ## timestamp
